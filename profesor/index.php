            ...
            <div class="col-12">
                <nav class="navbar navbar-expand-lg bg-body-tertiary">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="#">Profesor <span class="text-success"><?php echo $_SESSION['user_name'] ?></span><br><?php echo $_SESSION['name_prof'] ?></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarText">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item">
                                    <a class="nav-link" href="disponibilidad/">Disponibilidad y Carga Horaria</a>
                                </li>
                                <li class="nav-item">
