...
function mostrarFormulario() {
    Swal.fire({
        title: 'Crear Seccion',
        html:
            '<div class="form-floating"><select id="sedeID" class="form-select mb-3">' +
            cargarSelectSede(false, 0) +
            '</select><label for="sedeID">Sede</label></div>' +
            '<div class="form-floating"><select id="pnfID" class="form-select mb-3">' +
        ...
        preConfirm: () => {
            ...
            if ($('#sedeID').val() == '' || $('#pnfID').val() == '' || $('#Trayecto').val() == '' || $('#seccionName').val() == '') {
            ...
            crearSeccion($('#sedeID').val(), $('#pnfID').val(), $('#Trayecto').val(), $('#seccionName').val(), $('#pnfID option:selected').text());
        }
    });
}

function crearSeccion(sede_id, pnf_id, Trayecto, seccion, pnfName) {
    $.ajax({
        url: 'crud_seccion.php',
        type: 'POST',
        data: {
    ...
    $.ajax({
        ...
        success: function (res) {
            Swal.fire({
                ...
                html:
                    '<div class="form-floating"><select id="sedeID" class="form-select mb-3">' +
                    cargarSelectSede(true, res.Seccion.sede_id) +
                    '</select><label for="sedeID">Sede</label></div>' +
                    '<div class="form-floating"><select id="pnfID" class="form-select mb-3">' +
                    cargarSelectPNF(true, res.Seccion.pnf_id) +
                    '</select><label for="pnfID">PNF</label></div>' +
                ...
                preConfirm: () => {
                    ...
                    actualizarSeccionAjax(id, $('#sedeID').val(), $('#pnfID').val(), $('#Trayecto').val(), $('#seccionName').val(), $('#pnfID option:selected').text());
...
function actualizarSeccionAjax(id, sede_id, pnf_id, Trayecto, seccion, pnfName) {
