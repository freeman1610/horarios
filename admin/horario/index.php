    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 col-12">
                ...
                <select class="form-select" id="selectSede" onchange="cargarSecciones(this)">
                    <option value="">Seleccione</option>
                </select>
            </div>
            <div class="col-md-3 col-12">
                <label for="selectSeccion">Seleccione la Sección</label>
                <select class="form-select" id="selectSeccion" onchange="cargarContenido()" disabled="true">
                    <option value="">Seleccione</option>
                </select>
            </div>
            <div class="col-md-3 col-12">
                <label for="selectSeccion">Seleccione el Turno</label>
                <select class="form-select" id="selectTipoH" onchange="cargarContenido()" disabled="true">
                    <option value="">Seleccione</option>
